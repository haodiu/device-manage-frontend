        ...
        <div className="container-xxl">
          <div className="row">
            ...
            <div className="col-1 nav-option">
              {userDetail?.role === 'maintenance_staff' && <div className="btn-cont">
            ...
            {userDetail?.role === 'maintenance_staff' &&<div className="col-1 nav-option">
            ...
            {userDetail?.role === 'device_user' &&<div className="col-1 nav-option">
              <div className="btn-cont">
            ...
            {userDetail?.role && <div className="col-1 nav-option">
              <div className="btn-cont">
